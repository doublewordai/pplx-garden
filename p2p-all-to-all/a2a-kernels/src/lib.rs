...
mod ffi {
    unsafe extern "C++" {
        ...
        unsafe fn a2a_dispatch_send_node_rect(
            ...
            dispatch_source_counts_ptrs: *mut *mut u32,
            dispatch_source_count_epochs_ptrs: *mut *mut u32,
        ...
        unsafe fn a2a_dispatch_recv(
            ...
            dispatch_source_counts_ptrs: *mut *mut u32,
            dispatch_source_count_epochs_ptrs: *mut *mut u32,
            use_device_source_counts: bool,
            num_recv_tokens_ptr: *mut u32,
            num_recv_tokens_ready: *mut u32,
            dispatch_recv_flag: *mut u8,
            dispatch_recv_done: *mut u32,
            grid_counter: *mut u32,
            sync_counter: *mut u32,
            sync_ptrs: *mut *mut u32,
